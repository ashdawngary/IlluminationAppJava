...
public class tasklistv2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (readFromFile(this,"activity.txt").equals("0")){
            ...
            writeToFile("Activities For You","tasklist_choice",myContext);
    ...
    public void reloadtasks(String content){
        ...
        switch(content){
            case "Activities For You":
                ...
                break;
            case "Volunteering":
                String[] tsk = randomfiveSubset(getResources().getStringArray(R.array.activities_list));
                writeToFile(tsk[0],caller+"_0.txt",myContext);
                writeToFile(tsk[1],caller+"_1.txt",myContext);
                writeToFile(tsk[2],caller+"_2.txt",myContext);
                writeToFile(tsk[3],caller+"_3.txt",myContext);
                writeToFile(tsk[4],caller+"_4.txt",myContext);
                /*
                ...
                */
                break;
            default:
                Log.i("reloadtasks"," reloadtasks encountered bad argument: "+content+" defaulting to tasks for you.");
                writeToFile("Activities For You","tasklist_choice.txt",myContext);
                reloadtasks("Activities For You");
        }
    }
    ...
    public void loadchoice(){
        ...
        switch(choice){
            case "Volunteering":
                ...
                updateScreen(readFromFile(this,"volunteer_progress.txt"),getTasks("Volunteering"));
                break;
            case "Activities For You":
